...
export function isValidNamibianPhone(phone) {
    ...
    // Namibian phone formats:
    // +264 XX XXXXXXX (landline: 61-68 + 7 digits = 9 digits after +264)
    // +264 XX XXXXXXXX (mobile: 81-85 + 7-8 digits = 9-10 digits after +264)
    // 0XX XXXXXXX (local format)
    // Valid prefixes after country code: 61-68 (landline), 81-85 (mobile)
    const regex = /^(\+264|0)(?:6[1-8]|8[1-5])\d{7,8}$/;
